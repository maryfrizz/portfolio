...
export function HomeFooterSection() {
  return (
    <footer className="bg-white">
      <PageContainer
        className="flex flex-col items-start gap-6 px-[15px] py-6 md:flex-row md:flex-wrap md:items-end md:justify-between md:gap-x-8 md:gap-y-6 md:px-14 md:py-20"
        style={{ maxWidth: "none" }}
      >
