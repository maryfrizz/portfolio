  ...
  return (
    ...
    >
      <div className="flex flex-col items-start gap-[30px] lg:flex-row lg:gap-5">
        <div className="order-2 aspect-[662/535] w-full overflow-hidden rounded-lg lg:order-1 lg:min-w-0 lg:flex-1">
          <Image
        ...
        <div className="order-1 aspect-[476/298] w-full overflow-hidden rounded-lg lg:order-2 lg:w-[476px] lg:shrink-0">
          <Image
