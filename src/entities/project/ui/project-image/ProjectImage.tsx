...
export function ProjectImage({ media, priority = false }: ProjectImageProps) {
  return (
    <div className="relative h-[412px] w-screen shrink-0 overflow-hidden rounded-[16px] bg-[#f4f1f6] md:h-[431px] md:w-[calc((100vw-16px)/2)] xl:h-[827px] xl:w-auto xl:min-w-0 xl:rounded-[20px]">
      {media.type === "video" ? (
        <video
